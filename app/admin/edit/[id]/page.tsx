            ...
            <form action={updateRecord} className="grid grid-cols-1 md:grid-cols-12 gap-12">
                ...
                <div className="md:col-span-7 space-y-8">
                    <section className="space-y-4">
                        <h2 className="text-[10px] font-mono uppercase tracking-widest text-zinc-400">Editorial_Data</h2>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1">
                                <label className="text-[10px] font-mono uppercase text-zinc-500">Title</label>
                                <input name="title" defaultValue={record.title} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                            </div>
                            <div className="flex flex-col gap-1">
                                <label className="text-[10px] font-mono uppercase text-zinc-500">Artist</label>
                                <input name="artistName" defaultValue={record.artistName} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-mono uppercase text-zinc-500">Tagline (Metadata)</label>
                            <input name="metadataTagline" defaultValue={record.metadataTagline} className="border border-zinc-200 p-2 text-sm bg-zinc-50" placeholder="e.g. A THRESHOLD OF ANALOG CONSCIOUSNESS" />
                        </div>
                        <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-mono uppercase text-zinc-500">Etymology</label>
                            <textarea name="etymology" defaultValue={record.etymology} rows={3} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                        </div>
                        <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-mono uppercase text-zinc-500">Description</label>
                            <textarea name="description" defaultValue={record.description} rows={6} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                        </div>
                    </section>
                </div>
                ...
                <div className="md:col-span-5 space-y-8">
                    <section className="space-y-4">
                        <h2 className="text-[10px] font-mono uppercase tracking-widest text-zinc-400">Technical_Manifest</h2>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="flex flex-col gap-1">
                                <label className="text-[10px] font-mono uppercase text-zinc-500">Catalog #</label>
                                <input name="catalogNumber" defaultValue={record.catalogNumber} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                            </div>
                            <div className="flex flex-col gap-1">
                                <label className="text-[10px] font-mono uppercase text-zinc-500">Year</label>
                                <input name="year" defaultValue={record.year} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                            </div>
                            <div className="flex flex-col gap-1">
                                <label className="text-[10px] font-mono uppercase text-zinc-500">BPM / Tempo</label>
                                <input name="tempo" defaultValue={record.tempo} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                            </div>
                            <div className="flex flex-col gap-1">
                                <label className="text-[10px] font-mono uppercase text-zinc-500">Key</label>
                                <input name="key" defaultValue={record.key} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                            </div>
                        </div>
                        <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-mono uppercase text-zinc-500">Loudness (LUFS/dB)</label>
                            <input name="loudness" defaultValue={record.loudness} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                        </div>
                        <div className="flex flex-col gap-1">
                            <label className="text-[10px] font-mono uppercase text-zinc-500">Category / Phonetic</label>
                            <input name="phoneticOrCategory" defaultValue={record.phoneticOrCategory} className="border border-zinc-200 p-2 text-sm bg-zinc-50" />
                        </div>
                    </section>

                    <section className="space-y-4 pt-4 border-t">
                        <h2 className="text-[10px] font-mono uppercase tracking-widest text-zinc-400">Asset_Links</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-[10px] font-mono uppercase tracking-[0.5em] text-zinc-400 border-b pb-2">03_Tracklist_Refinement</h2>
                    ...
                    <button type="submit" className="w-full bg-zinc-900 text-white p-4 font-mono text-xs uppercase tracking-widest hover:bg-black">
                        Commit_Changes
                    </button>
                </div>
            </form>
